...
<div role="main" class="main">
        ...
        <div class="container pt-5 mt-5">
            <div class="row py-5">
                <div class="col text-center">
                    <h1 class="text-color-dark text-8 font-weight-bold">About Us</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="container pt-4 pb-5 mb-5">
        <div class="row">
            <div class="col">
                <p class="font-weight-medium text-4-5 line-height-5">Lorem ipsum dolor sit amet, consectetur adipiscing
                    elit. Sed dictum eleifend eros a pharetra. Cras aliquam vestibulum vehicula. Sed sed lectus risus.
                    Vestibulum maximus ac purus in euismod. In venenatis tellus ante, id porta risus semper quis. Aenean
                    vel posuere urna, sit amet placerat massa. Quisque efficitur interdum libero, sed dictum lorem
                    euismod sed.</p>
                <p class="text-3-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed dictum eleifend eros a
                    pharetra. Cras aliquam vestibulum vehicula. Sed sed lectus risus. Vestibulum maximus ac purus in
                    euismod. In venenatis tellus ante, id porta risus semper quis. Aenean vel posuere urna, sit amet
                    placerat massa. Quisque efficitur interdum libero, sed dictum lorem euismod sed.</p>
            </div>
        </div>
        <div class="row py-4">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <img src="img/demos/business-consulting-5/generic/generic-1.jpg" class="img-fluid" alt="">
            </div>
            <div class="col-lg-6">
                <img src="img/demos/business-consulting-5/generic/generic-2.jpg" class="img-fluid" alt="">
            </div>
        </div>
        <div class="row align-items-center mb-5">
            <div class="col-lg-8 text-center text-lg-start">
                <h3 class="mt-5 pt-4">Ongoing analysis of your<br>industry competitors</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin eget eleifend dolor, et maximus
                    enim.<br> Donec metus tellus, ornare in fermentum in, vulputate ut lorem.</p>
                <a href="#"
                    class="btn btn-modern btn-secondary box-shadow-6 border-0 text-transform-none btn-dash mt-2 py-3 px-5">Learn
                    More</a>
            </div>
            <div class="col-lg-4 p-relative pt-5 max-width-custom-1">
                <div class="p-absolute left-0">
                    <div data-plugin-float-element
                        ...
                        <img width="470" height="451" src="img/demos/business-consulting-5/svg/icon-bg-2.svg" alt=""
                ...
                <div data-plugin-float-element
                    ...
                    <img width="376" height="350" src="img/demos/business-consulting-5/svg/icon-2.svg" alt="" data-icon
        ...
        <div class="row mt-5 py-5">
            <div class="col-lg-6">
                ...
                <div class="row text-center mt-4">
                    <div class="col-md-6 mb-4 mb-md-0">
                        <img src="img/demos/business-consulting-5/icons/icon-3.png" class="img-fluid mb-3" alt="">
                        <h4 class="mb-1">Top Seo 2023</h4>
                        <p>Porto Awards 2023</p>
                    </div>
                    <div class="col-md-6 mb-4 mb-md-0">
                        <img src="img/demos/business-consulting-5/icons/icon-4.png" class="img-fluid mb-3" alt="">
                        <h4 class="mb-1">Top Seo 2023</h4>
                        <p>Porto Awards 2023</p>
                    </div>
                    <div class="col-md-6 mb-4 mb-md-0">
                        <img src="img/demos/business-consulting-5/icons/icon-5.png" class="img-fluid mb-3" alt="">
                        <h4 class="mb-1">Top Seo 2023</h4>
                        <p>Porto Awards 2023</p>
                    </div>
                    <div class="col-md-6 mb-4 mb-md-0">
                        <img src="img/demos/business-consulting-5/icons/icon-6.png" class="img-fluid mb-3" alt="">
                        <h4 class="mb-1">Top Seo 2023</h4>
                        <p>Porto Awards 2023</p>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                <div class="accordion accordion-modern-status accordion-modern-status-arrow" id="accordion200">
                    <div class="card card-default">
                        <div class="card-header bg-transparent bg-hover-quaternary transition-2ms"
                            id="collapse200HeadingOne">
                            <h4 class="card-title m-0">
                                <a class="accordion-toggle bg-transparent border-0 text-color-dark font-weight-bold collapsed"
                ...
                <div class="col-lg-6 text-center py-5">
                    ...
                    <div class="hstack d-block d-lg-flex gap-3">
                        <div class="ms-auto">
                            ...
                            <a href="https://www.okler.net/cdn-cgi/l/email-protection#d2abbda792b6bdbfb3bbbcfcb1bdbf"
                                class="text-decoration-none text-5 text-primary text-color-hover-light ws-nowrap font-weight-semi-bold"><span
                                    class="__cf_email__"
                                    data-cfemail="0e7e617c7a614e6a61636f6760206d6163">[email&#160;protected]</span></a>
                        </div>
