...
<div role="main" class="main">
        ...
        <div class="container pt-5 mt-5">
            <div class="row py-5">
                <div class="col text-center">
                    <h1 class="text-color-dark text-8 font-weight-bold">Success Stories</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="container pt-4 pb-5 mb-5">
        <div class="row">
            <div class="col">
                <img src="img/demos/business-consulting-5/generic/generic-3.jpg" class="img-fluid" alt="">
            </div>
        </div>
            ...
            <div class="col-lg-10 text-center">
                <div class="card border-radius-0 bg-color-light border-0 box-shadow-1">
                    <div class="card-body p-5">
                        <div class="p-lg-5">
                            <h5 class="opacity-5">Web Marketing</h5>
                            <h3>Porto Boosts Organic Search</h3>
                            ...
                            <a href="#" class="btn btn-modern btn-primary box-shadow-6 border-0 text-transform-none btn-dash mt-2 py-3 px-5">Full Case Study</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mb-5">
            <div class="col-lg-6">
                <div class="row">
                    <div class="col">
                        <img src="img/demos/business-consulting-5/generic/generic-4.jpg" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="row justify-content-center p-relative custom-el-pos-3">
                    <div class="col-lg-10 text-center">
                        <div class="card border-radius-0 bg-color-light border-0 box-shadow-1">
                            <div class="card-body p-5">
                                <div class="p-lg-2">
                                    <h5 class="opacity-5">Web Marketing</h5>
                                    <h3 class="text-6">Porto Reduces Cost Per Click</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin eget eleifend dolor, et maximus enim. Donec metus tellus, ornare in fermentum in, vulputate ut lorem.</p>
                                    <a href="#" class="btn btn-modern btn-secondary box-shadow-6 border-0 text-transform-none btn-dash mt-2 py-3 px-5">Full Case Study</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="row">
                    <div class="col">
                        <img src="img/demos/business-consulting-5/generic/generic-5.jpg" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="row justify-content-center p-relative custom-el-pos-3">
                    <div class="col-lg-10 text-center">
                        <div class="card border-radius-0 bg-color-light border-0 box-shadow-1">
                            <div class="card-body p-5">
                                <div class="p-lg-2">
                                    <h5 class="opacity-5">Web Marketing</h5>
                                    <h3 class="text-6">Porto Increases Post Engagement</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin eget eleifend dolor, et maximus enim. Donec metus tellus, ornare in fermentum in, vulputate ut lorem.</p>
                                    <a href="#" class="btn btn-modern btn-secondary box-shadow-6 border-0 text-transform-none btn-dash mt-2 py-3 px-5">Full Case Study</a>
                                </div>
                            </div>
        ...
        <div class="row mb-5">
            <div class="col-lg-6">
                <div class="row">
                    <div class="col">
                        <img src="img/demos/business-consulting-5/generic/generic-6.jpg" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="row justify-content-center p-relative custom-el-pos-3">
                    <div class="col-lg-10 text-center">
                        <div class="card border-radius-0 bg-color-light border-0 box-shadow-1">
                            <div class="card-body p-5">
                                <div class="p-lg-2">
                                    <h5 class="opacity-5">Web Marketing</h5>
                                    <h3 class="text-6">Porto Boosts Search Results</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin eget eleifend dolor, et maximus enim. Donec metus tellus, ornare in fermentum in, vulputate ut lorem.</p>
                                    <a href="#" class="btn btn-modern btn-secondary box-shadow-6 border-0 text-transform-none btn-dash mt-2 py-3 px-5">Full Case Study</a>
                                </div>
                            </div>
            ...
            <div class="col-lg-6">
                <div class="row">
                    <div class="col">
                        <img src="img/demos/business-consulting-5/generic/generic-7.jpg" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="row justify-content-center p-relative custom-el-pos-3">
                    <div class="col-lg-10 text-center">
                        <div class="card border-radius-0 bg-color-light border-0 box-shadow-1">
                            <div class="card-body p-5">
                                <div class="p-lg-2">
                                    <h5 class="opacity-5">Web Marketing</h5>
                                    <h3 class="text-6">Porto Boosts Leads</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin eget eleifend dolor, et maximus enim. Donec metus tellus, ornare in fermentum in, vulputate ut lorem.</p>
                                    <a href="#" class="btn btn-modern btn-secondary box-shadow-6 border-0 text-transform-none btn-dash mt-2 py-3 px-5">Full Case Study</a>
                                </div>
                            </div>
                        ...
                        <div class="card-body py-3 px-2">
                            <div class="testimonial testimonial-style-4 border-0 box-shadow-none m-0 p-0">
                                <div class="testimonial-author pb-3">
                                    ...
                                    <p><strong class="font-weight-bold">John Smith</strong><span>CEO & Founder - Okler</span></p>
                                </div>
        ...
        <div class="container py-5">
            <div class="row py-5 justify-content-center">
                <div class="col-lg-6 text-center py-5">
                    ...
                    <p class="text-4 text-light line-height-4 opacity-6 mb-4">Lorem ipsum dolor sit amet, consectetur lorem ipsum aipiscing anc vivita consectetur lorem ipsum aipiscing anc vivita consectetur lorem ipsum aipiscing anc vivita.</p>

                    <div class="hstack d-block d-lg-flex gap-3">
                        <div class="ms-auto">
                            <i class="icons icon-envelope text-color-primary text-8 p-relative top-12 me-2"></i>
                            <a href="https://www.okler.net/cdn-cgi/l/email-protection#7801170d381c1715191116561b1715" class="text-decoration-none text-5 text-primary text-color-hover-light ws-nowrap font-weight-semi-bold"><span class="__cf_email__" data-cfemail="f888978a8c97b89c9795999196d69b9795">[email&#160;protected]</span></a>		
                        </div>
                        ...
                        <div class="me-auto mt-3 mt-lg-0">
                            ...
                            <a href="tel:+1234567890" class="text-decoration-none text-5 text-primary text-color-hover-light ws-nowrap font-weight-semi-bold">888 123 4567</a>
                        </div>
                    </div>
